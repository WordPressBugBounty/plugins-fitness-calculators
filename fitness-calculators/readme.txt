...
Donate link:
Tags: Fitness calculator, water intake calculator, protein intake calculator, bmi calculator, BFP (Body Fat Percentage) calculator
...
5. #### CC (Carbohydrate) calculator ####
This calculator will ask you to add height,weight and age.
After calculating the given data, this calculator will show you your Carb value with different classifications according to the BMR.
> `Shortcode : [fcp-cc-calculator]`
...
1. screnshort-1.png shows Water intake calculator.
2. screnshort-2.png shows Protein intake calculator.
3. screnshort-3.png shows BMI calculator.
4. screnshort-4.png shows BFP calculator.
5. screnshort-5.png shows Carb calculator.
