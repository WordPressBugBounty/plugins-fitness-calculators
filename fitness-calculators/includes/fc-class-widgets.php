...
class Fcpwater_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        echo esc_html_e($args['before_widget']);
        if ( ! empty( $title ) )
        echo esc_html_e($args['before_title'] . $title . $args['after_title']);        
        echo esc_html_e(do_shortcode('[fcp-water-intake-calculator]'));
        echo esc_html_e($args['after_widget']);
    }
    ...
    if ( isset( $instance[ 'title' ] ) ) {
            ...
            ?>
            <p>
            <label for="<?php echo esc_html_e($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:' ); ?></label> 
            <input class="widefat" id="<?php echo esc_html_e($this->get_field_id( 'title' )); ?>" name="<?php echo esc_html_e($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>
    <?php 
    }
...
class Fcpbmi_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $title ) )
        echo esc_html_e($args['before_title'] . $title . $args['after_title']);        
        echo esc_html_e(do_shortcode('[fcp-bmi-calculator]'));
        echo esc_html_e($args['after_widget']);
    }
...
class Fcpbfc_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $title ) )
        echo esc_html_e($args['before_title'] . $title . $args['after_title']);        
        echo esc_html_e(do_shortcode('[fcp-bfc-calculator]'));
        echo esc_html_e($args['after_widget']);
    }
